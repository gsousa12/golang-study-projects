...
const (
	TransactionService_ValidateBalance_FullMethodName = "/transfer.TransactionService/ValidateBalance"
)
...
type TransactionServiceClient interface {
	ValidateBalance(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*TransferResponse, error)
}
...
func (c *transactionServiceClient) ValidateBalance(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*TransferResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransferResponse)
	err := c.cc.Invoke(ctx, TransactionService_ValidateBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransactionServiceServer interface {
	ValidateBalance(context.Context, *TransferRequest) (*TransferResponse, error)
...
func (UnimplementedTransactionServiceServer) ValidateBalance(context.Context, *TransferRequest) (*TransferResponse, error) {
...
func _TransactionService_ValidateBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransferRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionServiceServer).ValidateBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionService_ValidateBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).ValidateBalance(ctx, req.(*TransferRequest))
	}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "transfer.TransactionService",
	HandlerType: (*TransactionServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ValidateBalance",
			Handler:    _TransactionService_ValidateBalance_Handler,
		},
	},
...
const (
	ConversionService_ConvertAmount_FullMethodName = "/transfer.ConversionService/ConvertAmount"
)
...
type ConversionServiceClient interface {
	ConvertAmount(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*TransferResponse, error)
}
...
func (c *conversionServiceClient) ConvertAmount(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*TransferResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransferResponse)
	err := c.cc.Invoke(ctx, ConversionService_ConvertAmount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConversionServiceServer interface {
	ConvertAmount(context.Context, *TransferRequest) (*TransferResponse, error)
...
func (UnimplementedConversionServiceServer) ConvertAmount(context.Context, *TransferRequest) (*TransferResponse, error) {
...
func _ConversionService_ConvertAmount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversionService_ConvertAmount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversionServiceServer).ConvertAmount(ctx, req.(*TransferRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ConversionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "transfer.ConversionService",
